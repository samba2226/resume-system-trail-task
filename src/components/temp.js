...
//         {data.personal && (
//           <div className="mb-3">
//             {data.personal.photo && <img src={data.personal.photo} alt="Profile" style={{ maxWidth: "150px" }} className="mb-2 rounded" />}
...
//             {data.education.details.map((d, idx) => (
//               <p key={idx}>{d.degree} - {d.institute} ({d.year})</p>
//             ))}
//           </div>
//         )}
//       </div>
